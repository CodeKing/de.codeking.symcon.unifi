        ...
        if (isset(Kint_Object_Color::$color_map[$value])) {
            ...
            foreach ($value as $i => &$color) {
                ...
                if (strpos($color, '%') !== false) {
                    ...
                    if ($i === 3) {
                        $color = $color / 100;
                    } elseif (in_array($variant, [self::COLOR_RGB, self::COLOR_RGBA])) {
                        $color = round($color / 100 * 255);
                    } elseif ($i === 0 && in_array($variant, [self::COLOR_HSL, self::COLOR_HSLA])) {
                        $color = $color / 100 * 360;
                    }
                }

                if ($i === 0 && in_array($variant, [self::COLOR_HSL, self::COLOR_HSLA])) {
