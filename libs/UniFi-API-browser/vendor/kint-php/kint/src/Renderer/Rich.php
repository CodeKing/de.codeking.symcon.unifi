...
class Kint_Renderer_Rich extends Kint_Renderer
{
    ...
    public function postRender()
    {
        ...
        if (isset($this->previous_caller['function'])
            && !in_array($this->previous_caller['function'], ['include', 'include_once', 'require', 'require_once'])
        ) {
        ...
        if (!empty($this->mini_trace)) {
            ...
            foreach ($this->mini_trace as $step) {
                ...
                if (isset($step['function'])
                    && !in_array($step['function'], ['include', 'include_once', 'require', 'require_once'])
                ) {
                    $output .= ' [';
                    if (isset($step['class'])) {
                        $output .= $step['class'];
